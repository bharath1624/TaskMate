...
import { Play, Square, Trash2, History } from "lucide-react";
...
export const TaskTimeTracker = ({ taskId, canEdit, isOwner = false }: Props) => {
    ...
    return (
        /* ✅ Removed the outer border/card and main header */
        <div className="flex flex-col gap-5 w-full">

            {/* Kept the total time summary block */}
            <div className="flex items-center justify-between bg-muted/30 px-3 py-2.5 rounded-lg border border-border/50">
                <span className="text-xs font-medium text-muted-foreground">Total Time Spent</span>
