...
const postData = async <T>(url: string, data: unknown, config?: AxiosRequestConfig): Promise<T> => {
...
const fetchData = async <T>(url: string, p0?: { method: string; }): Promise<T> => {
...
export { postData, fetchData, updateData, deleteData, patchData, api };